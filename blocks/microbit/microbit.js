 ...
 * inspired from BlocklyDuino: https://github.com/BlocklyDuino/BlocklyDuino
 * @author carlosperate https://github.com/PyBlocks/microbit_blocks
 */
...
Blockly.Blocks['microbit_accelerometer_get_x'] = {
  init: function() {
    this.jsonInit({"colour": 0, "output": "Number", "helpUrl": "https://microbit-micropython.readthedocs.io/en/latest/accelerometer.html#microbit.accelerometer.get_x", "tooltip": "Get the acceleration measurement in the X axis.", "message0": Blockly.Msg.MICROBIT_ACCELEROMETER_GET_X_MESSAGE0});
  }
};
